# halo-agent-presets Specification

## Purpose
Define built-in Halo server-side Agent tools for public resource search, resource detail, latest content, taxonomy navigation, pages, and comments.
